...
class PdfdocTestCase(NearTestCase):
    ...
    def testPDFText(self):
        self.assertEquals(pdfdoc.PDFText('Hello World').format(self.doc),b'<48656c6c6f20576f726c64>')
    ...
    def testPDFString(self):
        ...
        self.assertEquals(pdfdoc.PDFString(b'Hello\xc2\xa0World',1).format(self.doc),'(\\376\\377\\000H\\000e\\000l\\000l\\000o\\000\\240\\000W\\000o\\000r\\000l\\000d)')
        ...
        self.assertEquals(pdfdoc.PDFString(u'Hello\xa0World',0).format(self.doc),b'(\xfe\xff\x00H\x00e\x00l\x00l\x00o\x00\xa0\x00W\x00o\x00r\x00l\x00d)')
